...
@pytest.mark.parametrize("make, model, postal_code, condition, error_message",
                         [
                             ('BMW', 'M4', ' ', 'New & Used', 'Zip Code is a mandatory'),
                             ('Bentley', 'Continental', '20003', 'Used'),
                             ('Land Rover', 'Range Rover Sport', '00001', 'New')
                         ])
@pytest.mark.regressiontest
def test_ebay_search_vehicle_multiple_invalid(browser, make, model, postal_code, condition):
    base_url = 'https://www.ebay.com/'
    expected_title = 'Electronics, Cars, Fashion, Collectibles & More | eBay'
